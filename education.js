...
function renderEducationPanel(nation, nationId) {
  ...
  html += `<h4 style="margin:0 0 10px">🎓 Education System — ${nation.flag || ''} ${nation.name || nationId}</h4>`;
  ...
  [
    ...
    { label: '🏛️ Secondary', enroll: es.secondaryEnrollPct, complete: es.secondaryCompletePct, grads: es.secondaryGrads },
